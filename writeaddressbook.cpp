...
// Function fills in a Person message based on user input
...
// Main function that reads the entire address book from file, adds a person and writes it 
// back to the file
int main(int argc, char* argv[]) {
  // Verify version of the library that we linked against is compatible with the version of
  ...
  // This is optional: it deletes all global objects allocated by libprotobuf
